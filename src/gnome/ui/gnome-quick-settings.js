...
export const GnomeQuickSettings = GObject.registerClass(
    class GnomeQuickSettings extends QuickSettings.SystemIndicator {
        constructor(actions = {}) {
            super();
            ...
            this._item.menu.setHeader(
                'display-symbolic',
                'Per-Monitor Screen Blank',
            );
            this._profileSection = undefined;
            this._item.menu.addMenuItem(new PopupMenu.PopupSeparatorMenuItem());
            this._item.menu.addAction('Open Settings', () =>
                this._actions.openSettings?.(),
            );
        ...
        _syncProfiles() {
            ...
            const state = this._profileGetter?.() ?? {
                profiles: [],
                activeProfileId: '',
            };
            ...
            for (const profile of state.profiles) {
                ...
                row.connect('activate', () =>
                    this._onSelectProfile?.(profile.id),
                );
